package com.example.intq.common.util.logger.conf;

import com.example.intq.common.util.logger.printer.ConsolePrinter;
import com.example.intq.common.util.logger.printer.LogPrinter;
